        ...
        <>
            ...
            <div className="h-[80px] w-full flex justify-between items-center max-w-7xl px-3 mx-auto">
                <p className="flex items-center justify-center gap-2">
                    <h2 className="text-gray-500 text-3xl">Aeon</h2>
                    <MdSunny className="text-3xl mt-1 text-yellow-400"/>
                </p>
                <section className="flex gap-2 items-center">
                    <MdGpsFixed title="Your location" onClick={handleCurrentLocation} className="text-3xl text-gray-500 hover:opacity-80 cursor-pointer"/>
